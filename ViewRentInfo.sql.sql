...
Rent.DateEnd AS DateEnd, Rent.TotalRentCost AS RentCost, Rent.TotalDepositCost AS Deposit
FROM ProductRent
...
GROUP BY Rent.Id, Tenant.FIO, Rent.TotalRentCost, Rent.DateStart, Rent.DateEnd , Rent.TotalDepositCost